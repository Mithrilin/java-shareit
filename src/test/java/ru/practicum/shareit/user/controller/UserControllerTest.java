...
class UserControllerTest {
    ...
    @Test
    @DisplayName("Ошибка при сохранении пользователя, когда почта не валидная")
    void createUser_whenEmailNotValid_thenThrowException() throws Exception {
        UserDto userDto = new UserDto("name", "email.ru");
        userDto.setId(1L);
        ...
        verify(userService, never()).addUser(Mockito.any());
    }
    ...
    @Test
    @DisplayName("Ошибка при обновлении пользователя, кода ИД не положительный")
    void updateUser_whenUserDtoIsValidAndIdNotPositive_thenThrowException() throws Exception {
        UserDto userDto = new UserDto("name", "email@mail.ru");
        userDto.setId(1L);
        ...
        verify(userService, never()).updateUser(Mockito.any());
    }
    ...
    @Test
    @DisplayName("Ошибка при обновлении пользователя, кода ИД не положительный")
    void getUserById_whenIdNotPositive_thenThrowException() throws Exception {
